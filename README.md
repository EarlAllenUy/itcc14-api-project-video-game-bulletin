...
| Name | GitHub Profile |
| :--- | :--- |
| **Alamo, Don Martin Raphael** | [https://github.com/MartinAlamo20](https://github.com/MartinAlamo20) |
| **Cruz, Niall Nevin** | [https://github.com/NiallCruz](https://github.com/NiallCruz) |
| **Uy, Earl Allen** | [https://github.com/EarlAllenUy](https://github.com/EarlAllenUy) |
| **Uyguangco, Kent Andrei** | [https://github.com/20230026875-glitch](https://github.com/20230026875-glitch) |
...
This phase completes all user-facing interactive features, including User Authentication (Registration, Login), Favoriting, and the Commenting system. The focus is on security, ensuring all endpoints are protected based on the user's role (Guest, Registered, Admin).

#### Deliverables

1. Authentication System: Fully functional User Registration (POST /users) and Login (POST /users/login) functionality.  
